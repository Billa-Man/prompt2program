...
class CleaningHandlerFactory:
  ...
  def create_handler(data_category: DataCategory) -> CleaningDataHandler:
    if data_category == DataCategory.SITES:
      return SiteCleaningHandler()
    else:
...
class EmbeddingHandlerFactory:
  ...
  def create_handler(data_category: DataCategory) -> EmbeddingDataHandler:
    ...
    elif data_category == DataCategory.SITES:
      return SiteEmbeddingHandler()
    else:
      raise ValueError("Unsupported data type")
